 ...
 */
package org.pac4j.hzbanksso.profile;
 ...
 * <p />
 * It is returned by the {@link org.pac4j.hzbanksso.client.CasClient} coupled with the {@link org.pac4j.hzbanksso.client.CasProxyReceptor}.
 * <p />
 ...
 * 
 * @see org.pac4j.hzbanksso.client.CasClient
 * @see org.pac4j.hzbanksso.client.CasProxyReceptor
 * @author Jerome Leleu
 * @since 1.4.0
 */
public class CasProxyProfile extends CasProfile {
    ...
    public String getProxyTicketFor(final String service) {
        if (this.attributePrincipal != null) {
            return this.attributePrincipal.getProxyTokenFor(service);
        }
        return null;
    }
}
