...
public final class ClientAction extends AbstractAction {
    ...
    protected Event doExecute(final RequestContext context) throws Exception {
       ...
       // final String clientName = request.getParameter(this.clients.getClientNameParameter());
        String p_clientName = request.getParameter(this.clients.getClientNameParameter());
        logger.debug("clientName : {}", p_clientName);
        
        //TODO:default set clientname to "CgbssoClient"
        //if(StringUtils.isBlank(p_clientName)){
        	//p_clientName="CgbssoClient";
        //}
        final String clientName =p_clientName;
        ...
        if (StringUtils.isNotBlank(clientName)) {
            ...
            if (credentials != null) {
            	ClientCredential cc = new ClientCredential(credentials);
            	CentralAuthenticationService  cas = this.centralAuthenticationService;
            	String ticketValue = cas.createTicketGrantingTicket(cc);
