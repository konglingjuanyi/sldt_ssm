/*
  $Id: BindConnectionInitializer.java 2885 2014-02-05 21:28:49Z dfisher $
 ...
 */
public class BindConnectionInitializer extends org.ldaptive.BindConnectionInitializer
{
  ...
  {
	//zzg 20141017
	String realVal=PdsCfgMgr.getUserDn(dn);
    logger.trace("setting bindDn: {}", realVal);
    bindDn = realVal;
  }
