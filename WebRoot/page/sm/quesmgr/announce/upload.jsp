...
<body>
	...
	<div class="form-actions" align="center" style="margin-top: 158px">
		<button id="saveBtn" class="button button-info" onclick="rtSlModal()"><i class="fa fa-check icolor"></i> 提 交	</button>
		<button id="cancelBtn" class="button button-info" onclick="closWindow()"><i class="fa fa-close icolor"></i> 关 闭	</button>
	</div>
	</div>
</body>
<script type="text/javascript" src="<%=request.getContextPath()%>/page/sm/quesmgr/announce/js/upload.js"></script>   
</html>