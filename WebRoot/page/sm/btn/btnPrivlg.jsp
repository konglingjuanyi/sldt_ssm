...
<body>
	<div>
 		<ul id="btnPrivlgTree" class="ztree"></ul>
 	</div>	
  <div>
    <div style="height: 80px"></div>
 	<div class="form-actions" >
          <button id="btnPrivlgBtn" class="button button-info ipt_button" onclick="rtCfgModal()"><i class="fa fa-save icolor"></i> 确 定</button>
          <button class="button button-info ipt_button" data-dismiss="modal" onclick="closWindow()"><i class="fa fa-close icolor"></i> 取 消</button>
     </div>
   </div>
</body>
	<script type="text/javascript" src="<%=request.getContextPath()%>/page/sm/btn/js/btnPrivlg.js"></script>
</html>